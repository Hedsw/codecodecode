...
class GreetingStrategy { // Absctract Class
public:
    virtual ~GreetingStrategy() {};
    virtual void greet(const std::string & name) = 0;
};

class FormalGreetingStrategy : public GreetingStrategy { // Concrete class
public:
...
class NormalGreetingStrategy : public GreetingStrategy { // Concrete class
public:
    void greet(const std::string & name) {
...
class InformalGreetingStrategy : public GreetingStrategy { // Concrete class
public:
    void greet(const std::string & name) {
